...
ifeq ($(config),x64d)
  RESCOMP = windres
  TARGETDIR = ../../../bin/yaml-cpp/x64d-linux-x86_64
  TARGET = $(TARGETDIR)/libyaml-cpp.a
  OBJDIR = ../../../obj/yaml-cpp/x64d-linux-x86_64
...
ifeq ($(config),x64)
  RESCOMP = windres
  TARGETDIR = ../../../bin/yaml-cpp/x64-linux-x86_64
  TARGET = $(TARGETDIR)/libyaml-cpp.a
  OBJDIR = ../../../obj/yaml-cpp/x64-linux-x86_64
  DEFINES += -DYAML_CPP_STATIC_DEFINE
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),armd)
  RESCOMP = windres
  TARGETDIR = ../../../bin/yaml-cpp/ARMd-linux-ARM
  TARGET = $(TARGETDIR)/libyaml-cpp.a
  OBJDIR = ../../../obj/yaml-cpp/ARMd-linux-ARM
  DEFINES += -DYAML_CPP_STATIC_DEFINE
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),arm)
  RESCOMP = windres
  TARGETDIR = ../../../bin/yaml-cpp/ARM-linux-ARM
  TARGET = $(TARGETDIR)/libyaml-cpp.a
  OBJDIR = ../../../obj/yaml-cpp/ARM-linux-ARM
  DEFINES += -DYAML_CPP_STATIC_DEFINE
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),arm64d)
  RESCOMP = windres
  TARGETDIR = ../../../bin/yaml-cpp/ARM64d-linux-ARM64
  TARGET = $(TARGETDIR)/libyaml-cpp.a
  OBJDIR = ../../../obj/yaml-cpp/ARM64d-linux-ARM64
  DEFINES += -DYAML_CPP_STATIC_DEFINE
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),arm64)
  RESCOMP = windres
  TARGETDIR = ../../../bin/yaml-cpp/ARM64-linux-ARM64
  TARGET = $(TARGETDIR)/libyaml-cpp.a
  OBJDIR = ../../../obj/yaml-cpp/ARM64-linux-ARM64
  DEFINES += -DYAML_CPP_STATIC_DEFINE
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
